...
- **语音合成**: 翻译完成后自动生成语音并播放（使用OpenAI TTS API）
...
- **OpenAI 1.12.0**: OpenAI SDK，用于调用TTS语音合成API
- **通义千问API**: 阿里云大语言模型服务
...
```bash
# Windows (PowerShell)
$env:QWEN_API_KEY="sk-xxxxxxxxxxxxxxxxxxxxxxxx"
$env:TTS_API_KEY="your_tts_api_key_here"

# Linux/Mac
export QWEN_API_KEY="sk-xxxxxxxxxxxxxxxxxxxxxxxx"
export TTS_API_KEY="your_tts_api_key_here"
```
...
```json
{
  ...
  "keywords": ["人工智能", "改变", "世界"],
  "audio_url": "/static/audio/output_20250323_143025.mp3"
}
```
...
| TTS_API_KEY | 语音合成API密钥 | - |
| TTS_API_URL | TTS API访问地址 | https://aiapiv2.pekpik.com/v1 |
| TTS_MODEL | TTS模型 | tts-1-hd |
| TTS_VOICE | TTS声音 | alloy |
